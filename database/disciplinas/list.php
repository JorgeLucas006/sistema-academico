...
$test = chr(46);
$sql = "SELECT disciplinas{$test}id,disciplinas{$test}codigo, disciplinas{$test}nome, PROFESSORES{$test}NOME as p_nome, count(DISCIPLINAS.aluno_disciplina) as count FROM disciplinas 
